...
- filename:       mimodulo.ko vs des_generic.ko
- author:         Catedra de SdeC vs Dag Arne Osvik <da@osvik.no>
- description:    Primer modulo ejemplo vs DES & Triple DES EDE Cipher Algorithms
- srcversion:     diferentes
- depends:          vs libdes
- name:           mimodulo vs des_generic
- signer:         Mi Firma vs Build time autogenerated kernel key
- sig_key:        diferentes
- sig_hashalgo:   sha256 vs sha512
- signature:      diferentes
...
Al ejecutar el programa [Hello](/hello_world/hello_simple.c) y utilizar `strace`, se obtuvo la salida [strace.txt](/hello_world/strace.txt).
